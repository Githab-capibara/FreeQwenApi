...
This directory holds binary/vector assets referenced by the documentation
in `docs/README.md` and other docs.
...
numbers or architecture change.

## Template

Use [`template.md`](template.md) as a starting point for new visual assets.
